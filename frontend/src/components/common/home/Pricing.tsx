    ...
    return (
        ...
        >
            ...
            <ul className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                <For each={[...Array(4)]}>
                    {() => (
                        <li className="relative space-y-6 overflow-hidden rounded-xl bg-white p-6 shadow-sm transition hover:scale-105 hover:shadow-xl dark:bg-gray-800">
                            <div
                            ...
                            <hgroup className="mt-4 space-y-6 border-b border-gray-100 pb-6 dark:border-gray-700">
                                ...
                                <p className="text-theme">
                                    ...
                                    elit. Velit, voluptatibus.
                                </p>
                            </hgroup>

                            <ul className="text-theme space-y-1">
                                <For each={[...Array(6)]}>
                                    {(_, i) => (
                                        <li>{i + 1} Lorem ipsum dolor sit amet.</li>
                                    )}
                                </For>
                            </ul>
